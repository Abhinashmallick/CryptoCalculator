class UI {
    ...
    //print the <option> from the form
    printCryptoCurrencies() {
        // console.log(cryptoAPI.getCryptoCurrenciesList() ); //it shows Promise ie we need extra .then
    ...
    // Print the message 2 parameters, message, classes
